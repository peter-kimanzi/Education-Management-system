...
<html lang="zxx">
<head>
<title>Kenema school website</title>
<!-- Meta tag Keywords -->
...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.php"><i class="fa fa-leanpub" aria-hidden="true"></i> Kenema</a></h1>
	...
	<div class="container">
		<div class="wthree_footer_grid_left">
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 wthree_footer_grid_right1">
				<h4>Contact Us</h4>
				<ul>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:kimjayden001@gmail.com"><?php echo "kimjayden001@gmail.com"; ?></a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i><a href="tel:+254712080741"><?php echo "+254712080741"; ?></a></li>
					<li><i class="fa fa-fax" aria-hidden="true"></i><a href=""><?php echo "Kenema"; ?></a></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<!-- Map-JavaScript -->
			...
			<script type="text/javascript">
				...
				function init() {
					var mapOptions = {
						zoom: 11,
						center: new google.maps.LatLng(1.2795, 36.8159),
					...
					var marker = new google.maps.Marker({
						position: new google.maps.LatLng(1.2795, 36.8159),
						map: map,
					});
				}
			</script>
